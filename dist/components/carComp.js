...
exports.renderCar = exports.renderFinishImage = exports.renderCarImage = void 0;
...
`;
exports.renderCarImage = renderCarImage;
const renderFinishImage = () => `
...
`;
exports.renderFinishImage = renderFinishImage;
const renderCar = ({ id, name, color, isEngineStarted, }) => `
  ...
  <div class="garage-list-item-race">
    ...
    <div class="garage-list-item-car-image" id="car-image-${id}">
      ${(0, exports.renderCarImage)(color)}
    </div>
    <div class="garage-list-item-finish id="finish-${id}">
      ${(0, exports.renderFinishImage)()}
    </div>
  </div>
`;
